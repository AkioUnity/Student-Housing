...
class Dashboard{
    ...
    public function get() {
    	$user = Auth::user();
		$mysqlCurrentTimezone = Database::table('users')->getCurrentTimezone();
		$mysqlCurrentDateTime = Database::table("users")->getCurrentDatetime();
    	if ($user->role == "user") {
    	...
    	if ($user->role == "superadmin") {
	        ...
	        return view('dashboard', compact("user","fileUsage","diskUsage","diskLimit","fileLimit","folders","pendingRequests","signed","unsigned","myPdf","myWord","myExcel","myPpt","systemDisk","systemFiles","systemUsers","businessAccounts","personalAccounts","totalPdf","totalWord","totalExcel","totalPpt", "mysqlCurrentTimezone", "mysqlCurrentDateTime"));
    	}else{
	        return view('dashboard', compact("user","fileUsage","diskUsage","diskLimit","fileLimit","folders","pendingRequests","signed","unsigned","myPdf","myWord","myExcel","myPpt", "mysqlCurrentTimezone", "mysqlCurrentDateTime"));
    	}
