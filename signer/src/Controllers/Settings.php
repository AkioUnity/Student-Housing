...
class Settings{
    ...
    public function get() {
        ...
        return view('settings', compact("user","company","reminders", "timezones", "currentDateTime"));
    }
    ...
    public function updatesystem() {
	    ...
	    $env->castBooleans();
	    $enableToggle = array("PKI_STATUS", "CERTIFICATE_DOWNLOAD", "NEW_ACCOUNTS","ALLOW_NON_PDF","USE_CLOUD_CONVERT","SHOW_SAAS","GUEST_SIGNING","FORCE_GUEST_SIGNING", "REGISTER_IP_ADDRESS_IN_HISTORY");
